...
def generate_semiprime_candidate(base_n: int, seed_row: np.ndarray) -> Tuple[int, int, int]:
    """
...
def extract_geofac_peaks(
    ...
    for idx, (row_id, n_base, qmc_row) in enumerate(
        ...
        try:
            ...
            N, p, q = generate_semiprime_candidate(int(n_base), qmc_row)
